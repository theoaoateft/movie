...
<body style="background-color:black;">
  <?php include_once 'customerHeader.php'; ?>
...
<div class="panel with-nav-tabs panel-success" style="background-color:black;">
  <div class="panel-heading" style="background-color:black;">
    <ul class="nav nav-tabs" style="background-color:black;">
      <h2 style="color: white; text-align: center" >Showing Now</h2>
    </ul>
  </div>
