...
//First input in database table
	if (!$dateExists) {
		...
		$sql02="UPDATE showOrder, theater SET showOrder.price=theater.price WHERE showOrder.theater=theater.theaterName";
		if ($conn->query($sql) === TRUE && $conn->query($sql02) === TRUE) {
			...
			$r=$result->fetch_object();
			$seatCount=$r->seat;
			$result=$conn->query("select price from showOrder where showOrderId='".$showOrder."';");
			$r=$result->fetch_object();
			$price=$r->price;
		}else{
...
// database e date time theater sob e ase
						...
						<div class=" col-md-8 col-lg-8 "> 
							<table class="table table-user-information">
								<tbody>
									...
									<tr>
										<td><strong>Food Ordered </strong></td>
